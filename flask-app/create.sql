...
DROP DOMAIN IF EXISTS _STATUS CASCADE;
DROP DOMAIN IF EXISTS _GENDER CASCADE;
DROP DOMAIN IF EXISTS _CODE CASCADE;
DROP DOMAIN IF EXISTS _PINTEGER CASCADE;
DROP DOMAIN IF EXISTS _PZEROINTEGER CASCADE;
DROP DOMAIN IF EXISTS _YEAR_1970 CASCADE;
DROP DOMAIN IF EXISTS _SEATS CASCADE;

DROP SEQUENCE IF EXISTS pilot_id_seq CASCADE;
DROP SEQUENCE IF EXISTS flight_id_seq CASCADE;
DROP SEQUENCE IF EXISTS plane_id_seq CASCADE;
DROP SEQUENCE IF EXISTS tech_id_seq CASCADE;
DROP SEQUENCE IF EXISTS res_id_seq CASCADE;
DROP SEQUENCE IF EXISTS flightinfo_id_seq CASCADE;
DROP SEQUENCE IF EXISTS repair_id_seq CASCADE;
...
CREATE SEQUENCE plane_id_seq  START WITH 66;
CREATE TABLE Plane
(
	id INTEGER NOT NULL,
...
CREATE SEQUENCE res_id_seq  START WITH 9999;
...
CREATE SEQUENCE flightinfo_id_seq  START WITH 2000;
...
CREATE SEQUENCE repair_id_seq  START WITH 550;
...
FROM '/Users/johnshin/Downloads/code/data/customer.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/pilots.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/planes.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/technician.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/flights.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/reservation.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/flightinfo.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/repairs.csv'
WITH DELIMITER ',';
...
FROM '/Users/johnshin/Downloads/code/data/schedule.csv'
WITH DELIMITER ',';
